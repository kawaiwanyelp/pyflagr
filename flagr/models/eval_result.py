...
from flagr.models.eval_context import EvalContext  # noqa: F401,E501
from flagr.models.eval_debug_log import EvalDebugLog  # noqa: F401,E501
...
class EvalResult(object):
    ...
    def variant_attachment(self, variant_attachment):
        ...
        :type: object
        """
        if variant_attachment is None:
            raise ValueError("Invalid value for `variant_attachment`, must not be `None`")  # noqa: E501
    ...
    def eval_context(self, eval_context):
        ...
        if eval_context is None:
            raise ValueError("Invalid value for `eval_context`, must not be `None`")  # noqa: E501
